...
%%       cancels) and 0.91 across campaigns (no shared unanchored pass); the
%%       visible-face row comes from the 2 x 2 design (126 cases, se 0.60). Colour
...
\begin{axis}[
  ...
  \node[font=\scriptsize, text=black!55, anchor=west] at (axis cs:3.0,4) {58/125};
