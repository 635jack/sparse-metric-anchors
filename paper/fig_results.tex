...
%%       error: 0.26 within a campaign (shared oracle frame, placement noise
...
%%       against the premise of the work.
%%
...
\begin{axis}[
  ...
  %   0,26 quand les deux conditions partagent le repere oracle (meme campagne :
...
\begin{axis}[
  ...
  \draw[black!30] (axis cs:-0.06,0) -- (axis cs:0.95,0);

  % 42 of the 45 cases
  \addplot[only marks, mark=o, mark size=1.25pt, draw=accent!75] coordinates {
    (0.833,1.45) (0.833,0.68) (0.833,0.75) (0.833,0.97) (0.833,0.84) (0.833,0.57)
    (0.333,1.64) (0.333,3.29) (0.333,1.01) (0.833,3.59) (0.833,-1.74) (0.833,3.67)
    (0.500,3.31) (0.500,2.29) (0.500,0.09) (0.500,4.18) (0.500,3.11) (0.500,8.15)
    (0.833,0.42) (0.833,-1.04) (0.833,0.67) (0.833,-10.43) (0.833,-1.25)
    (0.833,-0.92) (0.167,-3.98) (0.167,-0.72) (0.167,-0.87) (0.833,5.66)
    (0.833,-1.14) (0.833,-6.93) (0.667,7.02) (0.667,-5.67) (0.667,5.88)
    (0.833,7.60) (0.833,0.13) (0.833,-2.27) (0.833,10.12) (0.833,0.01)
    (0.833,9.76) (0.667,11.55) (0.667,0.94) (0.667,5.38)
  };
  % the three cases with NO contact on the occluded face
  \addplot[only marks, mark=*, mark size=2.2pt, draw=good, fill=good] coordinates {
    (0.000,9.16) (0.000,0.52) (0.000,7.36)
  };
  % least-squares fit: it slopes the wrong way
  \addplot[draw=bad, very thick, domain=0:0.85, samples=2] {-2.413*x + 3.413};

  \node[font=\scriptsize, text=bad, anchor=north east] at (axis cs:0.93,12.4)
    {$r=-0.145$};
  \node[font=\scriptsize, text=good, anchor=west, align=left]
    at (axis cs:0.06,9.9) {\rlblZero};
\end{axis}
