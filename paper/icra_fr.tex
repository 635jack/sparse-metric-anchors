...
l'estimation du repère consomme 59 à 74~\% du gain atteignable, et 91~\% de la
...
objets, l'écart médian entre graines vaut $131{,}8^\circ$ pour les objets asymétriques
et $134{,}4^\circ$ pour les symétriques ; 1 objet asymétrique sur 16 est stable sous
$30^\circ$, 0 sur 26 chez les symétriques ; la corrélation asymétrie / stabilité vaut
$-0{,}124$. Répéter le recalage déplace ces médianes de quelques degrés --- il
échantillonne des points au hasard, et sur un solide de révolution la rotation qu'il
trouve est arbitraire --- mais pas la conclusion au niveau de la partition : les
comptes d'objets stables et l'absence de toute relation asymétrie--stabilité sont
inchangés d'une exécution à l'autre. Le partage par symétrie écarte un artefact de mesure --- deux sorties
...
l'apprendre. L'estimer malgré tout coûte 59 à 74~\% du gain atteignable et explique
