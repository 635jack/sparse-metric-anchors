...
3{,}1\times10^{-4}$, test des signes), contre $+7{,}82$ lorsque le repère est donné :
l'estimation du repère consomme 59 à 74~\% du gain atteignable, et, une fois le
...
\begin{enumerate}
  ...
  $+3{,}21$ réalisé contre $+7{,}82$ repère donné
...
impacts seuls), restriction à la face cachée de la caméra (une caméra placée dans le
mauvais repère : $61$~\% de ces ancres seulement sont cachées de celle qui a rendu
l'image, voir les limites), et rejet des points où
...
\midrule
Gain moyen, repère donné (oracle) & $+7{,}82$ \\
\bottomrule
\end{tabular}
\end{table}
...
$+3{,}21$ contre $+7{,}82$ sur 42 objets, et $+1{,}79$ contre $+6{,}77$ sous le modèle
de palpation sur cinq. \textbf{L'estimation du repère absorbe 59 à 74~\% de ce que
...
cas de la campagne de stratégies de préhension, la visibilité étant décidée depuis la
...
ancres avec $87$~\%, $60$~\% et $30$~\% d'entre elles sur la face cachée de la caméra.
Leurs gains valent $+1{,}37$, $+1{,}73$ et $+2{,}55$ : la stratégie qui touche le
\emph{moins} la face cachée gagne le \emph{plus}, sans que le test des signes en
sépare aucune ($11/15$, $p = 0{,}118$ entre les deux dernières). Cas par cas, sur 45
cas, la corrélation entre part cachée et gain vaut $r = -0{,}001$
(Fig.~\ref{fig:results}b) : le nombre d'ancres que la caméra ne voit pas ne dit rien du
gain. Les ancres éparses ne complètent pas ce que la vision
...
caméra en $(2{,}2\,; -2{,}2\,; 1{,}8)$ ne le rende. Tous les calculs d'occultation ont
placé cette caméra dans le repère propre du maillage, à $68^\circ$ de celle du rendu :
projetées depuis là, les silhouettes de référence recouvrent les images d'entrée à
$0{,}51$ en moyenne sur 42 objets, contre $0{,}95$ avec la rotation, et l'étiquette
visible/cachée diffère sur $26$~\% de la surface. Nous l'avons trouvé tard. Les parts
cachées des stratégies de préhension et la Fig.~\ref{fig:results}b sont recalculées
depuis la caméra du rendu ; depuis la caméra mal placée, la corrélation valait
$-0{,}145$ et trois cas semblaient ne laisser aucune ancre sur la face cachée. Deux
artefacts gardent l'erreur. Les sites de palpation de la Sec.~\ref{sec:contactmodel}
ont été restreints à la face cachée de la caméra mal placée : vus de la caméra du
rendu, $61$~\% de leurs ancres sont cachées (de $15$ à $90$~\% selon l'objet), un jeu
majoritairement caché plutôt qu'un jeu de face cachée. Et la partition du rappel
visible/occulté, sur laquelle aucune affirmation ne repose, n'est pas fiable. Un défaut
plus petit s'y ajoute : le rendu normalise les objets à une dimension maximale de
$1{,}3$ quand le code d'occultation utilise $2{,}0$ ; caméra corrigée, il change
l'étiquette de $3$ des $45$ cas de préhension.
...
l'apprendre. L'estimer malgré tout coûte 59 à 74~\% du gain atteignable et explique ce qui varie d'une exécution à l'autre : repère gelé, l'ancrage n'ajoute aucune variance sur aucun de quatre objets.
